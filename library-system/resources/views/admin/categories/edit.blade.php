...
<div dir="rtl" class="bg-gray-50 min-h-screen font-tajawal text-gray-800">
  <div class="container mx-auto max-w-3xl px-6">
    ...
    <div class="mb-10 text-right">
      <h2 class="text-3xl font-extrabold text-indigo-700">تعديل التصنيف</h2>
    </div>
    ...
    <!-- النموذج -->
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="bg-white p-8 rounded-3xl shadow-md space-y-6">
      @csrf
      @method('PUT')
